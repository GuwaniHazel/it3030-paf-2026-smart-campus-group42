...
const AnimatedStat = ({ label, target, icon: Icon }) => {
  ...
  return (
    <div
      ref={ref}
      className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:scale-[1.03] hover:shadow-xl dark:border-slate-800 dark:bg-slate-900"
      data-aos="fade-up"
    >
      ...
      <p className="text-center text-3xl font-extrabold text-slate-900 dark:text-white">{value}</p>
      <p className="mt-1 text-center text-xs font-semibold uppercase tracking-[0.15em] text-slate-500 dark:text-slate-300">
        {label}
      </p>
    </div>
  );
    ...
    >
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-3xl" data-aos="fade-up">
            ...
            <h1 className="min-h-[70px] text-4xl font-extrabold leading-tight text-white sm:min-h-[94px] sm:text-5xl md:text-6xl">
              {typedTitle}
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <button
                ...
                className="animate-pulse rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-cyan-900/25 transition hover:-translate-y-0.5 hover:shadow-xl"
              >
                Launch Dashboard
              </button>
              <button
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-10 text-center" data-aos="fade-up">
          ...
          <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl">Live Statistics</h2>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-10 text-center" data-aos="fade-up">
          ...
          <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl">Platform Modules</h2>
        </div>
      ...
      <section className="bg-white py-16 dark:bg-slate-900/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center" data-aos="fade-up">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-500">Features</p>
            <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl">Core Capabilities</h2>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  ...
                  data-aos="fade-up"
                  data-aos-delay={index * 80}
                  className="rounded-2xl border border-slate-200 bg-slate-50 p-5 transition duration-300 hover:-translate-y-1 hover:bg-cyan-50 hover:shadow-lg dark:border-slate-800 dark:bg-slate-950 dark:hover:bg-slate-800"
                >
                  <div
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8" data-aos="fade-up">
        <div className="mb-8 text-center">
          ...
          <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl">What People Say</h2>
        </div>
      ...
      <section
        className="relative my-6 overflow-hidden bg-fixed py-20"
        style={{
          backgroundImage: `linear-gradient(115deg, rgba(8,47,73,0.86), rgba(2,132,199,0.72)), url(${CTA_BG_URL})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
